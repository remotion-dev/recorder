...
export const TransitionFromPreviousSubtitles: React.FC<{
  ...
  if (subtitleType === "below-video") {
    return (
      <div style={{ opacity: frame >= transitionDuration / 2 ? 1 : 0 }}>
        {children}
      </div>
    );
  }
    ...
    return (
      <div
        style={{
          ...
          opacity: interpolate(
            frame,
            [transitionDuration, transitionDuration + 5],
            [0, 1],
            {
...
export const TransitionToNextSubtitles: React.FC<{
  ...
  if (subtitleType === "below-video") {
    return (
      <div
        style={{
          opacity: frame < durationInFrames - transitionDuration / 2 ? 1 : 0,
        }}
      >
        {children}
      </div>
      ...
      <div
        style={{
          opacity: interpolate(
            frame,
            [
              durationInFrames - transitionDuration - 5,
